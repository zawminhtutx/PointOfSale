...
export default {
  ...
  theme: {
  	extend: {
  		...
  		colors: {
            'zenith-blue': 'rgb(59, 130, 246)',
            'zenith-dark': 'rgb(24, 24, 27)',
            'zenith-light': 'rgb(250, 250, 250)',
  		...
  		boxShadow: {
            ...
            'soft-lg': '0 4px 20px -4px rgba(0, 0, 0, 0.08), 0 12px 24px -3px rgba(0, 0, 0, 0.05)',
  			glow: '0 0 20px -5px rgb(59 130 246 / 0.4)',
  			'glow-lg': '0 0 40px -10px rgb(59 130 246 / 0.3)',
  			primary: '0 0 20px -5px rgb(59 130 246 / 0.4)',
  		...
  		backgroundImage: {
            'gradient-pos-hero': 'radial-gradient(circle at top, rgba(59, 130, 246, 0.1), transparent 40%)',
